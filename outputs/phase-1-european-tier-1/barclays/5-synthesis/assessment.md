...
|----|---------|------|------|---------|
| BARC-001 | FINOS IRS processing demo (Lee Braine) | 1 | pilot_or_poc | HIGH |
| BARC-002 | CDM prototype for CCPs (Oct 2021) | 1 | pilot_or_poc | HIGH |
| BARC-003 | "Business lines might die" advocacy (2019) | 2 | membership | MEDIUM |
| BARC-004 | DerivHack 2018 & 2019 hackathons | 1 | open_source | HIGH |
...
- Primary CDM advocate at Barclays
- Introduced FINOS CDM demonstration
- Quoted in multiple Risk.net articles warning about CDM necessity
- Led DerivHack hackathon initiatives
...
|---------------|-------------|--------|
| ARCHITECT-Native | Production deployment confirmed | NOT CONFIRMED |
| ARCHITECT-Leader | Pilot with significant contribution | PARTIAL (prototypes, demos) |
| **ARCHITECT-Follower** | Active FINOS contribution, membership | **YES** |
...
|---------|----------|--------|
| IRS | FINOS demo, CCP prototype | Prototype |
...
|------|---------------|------------|-------------------|
| **Barclays** | ARCHITECT-Follower | 75% | Prototypes, advocacy |
| BNP Paribas | ARCHITECT-Native | 90% | Production Q3 2022 |
| JP Morgan | ARCHITECT-Leader | 85% | FINOS maintainer |
| Deutsche Bank | PRAGMATIST | 55% | FINOS (non-CDM only) |
...
3. [Risk.net: Business Lines Might Die](https://www.risk.net/derivatives/7147901/use-cdm-or-some-business-lines-might-die-barclays)
4. [Risk.net: Infrastructure Push](https://www.risk.net/derivatives/7655006/common-domain-model-needs-infrastructure-push-says-barclays)
5. [Risk.net: Repo Clearing](https://www.risk.net/risk-management/7958532/repo-clearing-could-spur-cdm-adoption-barclays)
