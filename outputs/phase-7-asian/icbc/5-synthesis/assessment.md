# CDM/DRR Assessment: Industrial and Commercial Bank of China
...
| Attribute | Value |
|-----------|-------|
| Legal Name | Industrial and Commercial Bank of China |
...
### Why UNKNOWN (not PRAGMATIST)?

1. **Disclosure Gap**: Chinese state-owned banks have limited Western-facing technology disclosure
2. **Regulatory Divergence**: China's derivatives markets operate independently (CFETS, PBOC standards)
3. **Search Limitations**: Language barriers and access to Chinese-language technical documentation
4. **Systematic Pattern**: All Big Four Chinese banks show identical null results

### Why 30% Confidence?

- High confidence in null results (comprehensive search)
...
- **PBOC**: No CDM mandate
- **CBIRC**: Domestic reporting standards
- **CFETS**: China Foreign Exchange Trade System (domestic FX standard)
- **Exchanges**: Shanghai/Dalian/Zhengzhou (commodities), CFFEX (financial futures)
