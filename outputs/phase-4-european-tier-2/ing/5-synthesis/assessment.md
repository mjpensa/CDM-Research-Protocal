...
| Source | Result |
|--------|--------|
| ISDA CDM resources | No ING mention |
| FINOS member directory | ING not listed |
| GitHub finos/common-domain-model | No ING contributors |
| ING official announcements | No CDM references |

### Tier 2: Industry Sources
| Source | Result |
|--------|--------|
| Risk.net | No ING CDM coverage |
| Waters Technology | No ING CDM articles |
| Conference proceedings | No ING CDM presentations |

### Tier 3: Signal Sources
| Source | Result |
|--------|--------|
| Job postings | No CDM-related roles |
| LinkedIn | No CDM expertise signals |

### Evidence Counts
| Tier | Positive | Null | Total |
|------|----------|------|-------|
| Tier 1 | 0 | 2 | 2 |
| Tier 2 | 0 | 2 | 2 |
| Tier 3 | 0 | 0 | 0 |
...
|-------|--------------|---------------|
| Prior | 15.0% | 85.0% |
| Post-Tier 1 | 5.5% | 94.5% |
| Post-Tier 2 | 2.6% | 97.4% |
| Post-Tier 3 | 1.5% | 98.5% |
...
### Counter-Case
The strongest argument against UNKNOWN was that ING, as a major derivatives dealer, must have a solution for EMIR Refit compliance. If not CDM, then by definition they use traditional approaches, suggesting PRAGMATIST.

### Steelman
The UNKNOWN classification was defended on epistemic grounds: without positive evidence of any specific approach, classifying ING as PRAGMATIST would be inference beyond the data.
...
2. **No ISDA CDM Participation:** No ING representatives identified in CDM working groups
...
The null results are informative:

- **Strategic Choice:** ING appears to have chosen not to publicly engage with CDM
...
| Commerzbank | PRAGMATIST | 50% | Murex migration evidence |
| Credit Agricole | OBSERVER | 55% | ISDA Board member |
...
1. "ING Bank CDM Common Domain Model ISDA derivatives 2024 2025"
2. "ING FINOS member contributor 2024 open source fintech"
3. "ING derivatives DTCC regulatory reporting EMIR 2024"
4. "ING ISDA working group CDM DRR"

### B. Sources Consulted
- isda.org
- finos.org
- github.com/finos/common-domain-model
- ing.com
- risk.net
