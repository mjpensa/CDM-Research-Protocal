...
| Attribute | Value |
|-----------|-------|
| **Legal Name** | Crédit Agricole Corporate and Investment Bank |
| **Headquarters** | Montrouge, France |
| **Parent** | Crédit Agricole Group |
| **Type** | Corporate & Investment Bank |
...
| ID | Claim | Tier | Type | Source |
|----|-------|------|------|--------|
| CA-001 | Christine Cremel - ISDA Board Member since July 2020 | 1 | membership_or_participation | isda.org |
...
- **Title:** Managing Director, Head of Onboarding, Transaction Management & Clearing
- **Board Tenure:** July 2020 - present (4+ years)
- **2024 Status:** Re-elected for continuing term
...
- No evidence of CDM production usage
- No evidence of CDM pilot or proof-of-concept
- No FINOS CDM repository contributions
- No CDM working group participation found

### Why OBSERVER (not PRAGMATIST)

- Cannot confirm traditional platform usage
- No vendor announcements about Credit Agricole
- ISDA Board membership suggests at least awareness of CDM

### Why Ecosystem-Engaged (not Historical-Engagement)

- Board membership is active and ongoing (2024 re-election)
...
| UniCredit | OBSERVER (40%) | Historical board member |
| Commerzbank | PRAGMATIST (50%) | Murex migration |
