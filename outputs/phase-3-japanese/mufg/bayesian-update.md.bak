...
- P(No prominent visibility | Not Engaged) = 0.95
  - Non-engaged banks simply don't appear in CDM contexts

**Bayes Factor**:
- BF(Pragmatist / Architect) = 0.70 / 0.20 = 3.5 (favors Pragmatist)
- BF(Not Engaged / Architect) = 0.95 / 0.20 = 4.75 (strongly favors Not Engaged)
...
- P(Vendor-driven modernization | Not Engaged) = 0.40
  - Not engaged firms may not even be modernizing via vendors

**Bayes Factor**:
- BF(Pragmatist / Architect) = 0.80 / 0.30 = 2.67 (favors Pragmatist)
- BF(Not Engaged / Architect) = 0.40 / 0.30 = 1.33 (slight favor to Not Engaged)
...
- P(Compliance-driven adoption in subsidiaries | Not Engaged) = 0.20
...
- BF(Not Engaged / Architect) = 0.20 / 0.40 = 0.50 (favors Architect)

**Impact**: Moderate evidence for Pragmatist, evidence against Not Engaged
...
- P(Large bank, not derivatives innovator | Not Engaged) = 0.60
  - Not engaged could be large but focused elsewhere

**Bayes Factor**:
- BF(Pragmatist / Architect) = 0.70 / 0.25 = 2.8 (favors Pragmatist)
- BF(Not Engaged / Architect) = 0.60 / 0.25 = 2.4 (favors Not Engaged)

**Impact**: Moderate evidence against Architect, slight favor to Pragmatist over Not Engaged
...
- P(Established vendor ecosystem | Not Engaged) = 0.70
  - May use legacy versions of these platforms

**Bayes Factor**:
- BF(Pragmatist / Architect) = 0.85 / 0.50 = 1.7 (favors Pragmatist)
- BF(Not Engaged / Architect) = 0.70 / 0.50 = 1.4 (favors Not Engaged)
...
- P(No public CDM statements | Not Engaged) = 0.90
  - Not engaged firms have nothing to say

**Bayes Factor**:
- BF(Pragmatist / Architect) = 0.75 / 0.40 = 1.875 (favors Pragmatist)
- BF(Not Engaged / Architect) = 0.90 / 0.40 = 2.25 (favors Not Engaged)
...
- Prior Odds(Not Engaged / Architect) = 0.176 / 0.429 = 0.410
- Posterior Odds(Not Engaged / Architect) = 0.410 × 2.18 = **0.894**
...
- **P(Not Engaged | Evidence) = 6.2%** (down from 15%)
...
3. **Not Engaged probability decreased** (15% → 6.2%)
...
- Low probability of Architect (7.6%) or Not Engaged (6.2%)
