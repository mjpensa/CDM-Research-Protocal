# SMBC — CDM/DRR Research

## Bank Profile

| Attribute | Value |
|-----------|-------|
| **Full Name** | Sumitomo Mitsui Banking Corporation |
| **Bank ID** | smbc |
...
**Key Questions:**
1. Is SMBC building CDM capability for JSCC connectivity?
2. What type of response: CDM-native build vs minimum connectivity vs vendor?
3. Are there ISDA/FINOS contributions from SMBC?
...
- SMBC is a major derivatives dealer globally
...
**SEARCH 1.1:** "SMBC" OR "Sumitomo Mitsui" "annual report" 2024 "regulatory reporting" OR "derivatives technology"
- Target: Official disclosure of technology initiatives

**SEARCH 1.2:** site:isda.org "SMBC" OR "Sumitomo Mitsui"
- Target: Official ISDA communications

**SEARCH 1.3:** site:finos.org "SMBC" OR "Sumitomo Mitsui"
- Target: FINOS contributor/member documentation

**SEARCH 1.4:** "SMBC" JSCC CDM preparation connectivity
- Target: Official statements on JSCC CDM connectivity

### Tier 2 Searches: Industry Sources

**SEARCH 2.1:** "SMBC" "Common Domain Model" OR CDM 2024 2025
- Target: Trade press coverage

**SEARCH 2.2:** "SMBC" derivatives technology Japan regulatory
- Target: Japanese regulatory reporting approach

**SEARCH 2.3:** site:risk.net "SMBC" CDM OR derivatives
- Target: Specialist trade press

### Tier 3 Searches: Indirect Signals

**SEARCH 3.1:** "SMBC" OR "Sumitomo Mitsui" job posting CDM OR "regulatory reporting"
...
|------|----------------------|
| Nomura | SMBC should show similar JSCC response pattern |
| MUFG | SMBC should be consistent with MUFG |
| Mizuho | SMBC should be consistent with Mizuho |
...
Save outputs to:
- `outputs/phase-3-japanese/smbc/1-evidence/`
- `outputs/phase-3-japanese/smbc/2-bayesian/`
- `outputs/phase-3-japanese/smbc/3-gates/`
- `outputs/phase-3-japanese/smbc/4-adversarial/`
- `outputs/phase-3-japanese/smbc/5-synthesis/`
